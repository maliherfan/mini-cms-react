...
State Management: Editor/UI state is managed with Zustand via useEditorStore

Server state (pages CRUD, async state) is handled using a dedicated React hook usePages.
